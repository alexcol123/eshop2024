...
import { ImageType } from "@/app/admin/(admin-pages)/add-products/AddProductForm"
...
const SelectColor: React.FC<SelectColorProps> = ({ item, addImageToState, removeImageFromState, isProductCreated }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 overflow-y-auto border-b border-slate-200 items-center p-2 ">
